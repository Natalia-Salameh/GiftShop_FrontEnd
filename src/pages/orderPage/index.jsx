...
<div id='form-wrapper'>
  <form onSubmit={handleSubmit}>
    ...
    <div className='form-group mb-1'>
      <label className='mb-1' htmlFor='buyerName'>Full Name</label>
      <input
    ...
    <div className='form-group mb-1'>
      <label className='mb-1' htmlFor='buyerPhone'>Phone Number</label>
      <input
    ...
    <div className='form-group mb-1'>
      ...
      <div className='form-group mb-1'>
        <label className='mb-1' htmlFor='zipCode'>Zip</label>
        <input
          type='text'
          id='zipCode'
          className='form-control'
